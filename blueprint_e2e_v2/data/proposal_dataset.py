...
class MultiSpanProposalDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> dict[str, Any]:
        ...
        for vid in video_ids:
            ...
            if self.insert_gt_for_training and correct_video:
            ...
            ious, ge05, ge07 = DiagnosticLabelBuilder.span_labels(spans_sec, gt, correct_video)
            labels.append({"iou": ious, "ge05": ge05, "ge07": ge07})
            correct.append(correct_video)
        ...
        for i, (clip, sec) in enumerate(zip(per_video_spans_clip, per_video_spans_sec)):
            n = clip.shape[0]

# C6-A-R2 A3b teacher semantic diagnostic

- Status: `PASS_DIAGNOSTIC_ONLY`
- A3b teacher used for R2 training: `false`
- Official val used: `false`

```json
{
  "status": "PASS_DIAGNOSTIC_ONLY",
  "a3b_teacher_used_for_training": false,
  "official_val_used": false,
  "checks": {
    "a3b_boundary_ce_worse_than_frozen": true,
    "teacher_distillation_endpoint_delta_correlation_failed": {
      "pearson": -0.47737492034476703,
      "spearman": -0.40910982150592745
    },
    "a3b_z_raw_centered_delta_mixing_risk": "diagnosed; R2 uses no A3b teacher loss",
    "kl_direction_no_longer_main_training": "A3b KL removed from R2 objective"
  },
  "a3b_metrics": {

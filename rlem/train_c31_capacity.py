...
"""Train one C3.1 flexible evidence-head configuration on frozen C2 caches."""
...
def main():
    ...
    if forbidden & set(stats.feature_names) or len(stats.feature_names) != 31:
        raise ValueError("C3.1 requires the frozen 31-feature no-r2 schema")
